...
#>                         Direct     Indirect       Total
#> INC dy/dx          -0.05700667 -0.014643460 -0.07165013
#> HOVAL dy/dx        -0.02851468  0.002480576 -0.02603410
#> fDISCBDm2-m1 dy/dx  0.53615190 -1.821801702 -1.28564980
#> fDISCBDm3-m2 dy/dx  0.44837752 -0.008451688  0.43992583
#> fDISCBDm4-m3 dy/dx  0.57159014 -0.134564906  0.43702524
#> fEW1 dy/dx         -0.09418652  0.247893679  0.15370716
#> ========================================================
#> Standard errors:
#>                         Direct   Indirect      Total
#> INC dy/dx          0.033522268 0.05500753 0.05177221
#> HOVAL dy/dx        0.008460333 0.01570895 0.01266713
#> fDISCBDm2-m1 dy/dx 0.526900804 0.80321952 0.43061795
#> fDISCBDm3-m2 dy/dx 0.525906692 0.70085293 0.45630343
#> fDISCBDm4-m3 dy/dx 0.535329566 1.11949890 0.87187540
#> fEW1 dy/dx         0.579445971 0.67806872 0.22642611
#> ========================================================
#> Z-values:
#>                        Direct    Indirect      Total
#> INC dy/dx          -1.7005614 -0.26620828 -1.3839498
#> HOVAL dy/dx        -3.3703965  0.15790844 -2.0552480
#> fDISCBDm2-m1 dy/dx  1.0175576 -2.26812429 -2.9855927
#> fDISCBDm3-m2 dy/dx  0.8525800 -0.01205915  0.9641081
#> fDISCBDm4-m3 dy/dx  1.0677351 -0.12020102  0.5012474
#> fEW1 dy/dx         -0.1625458  0.36558784  0.6788403
#> 
#> p-values:
#>                    Direct    Indirect Total    
#> INC dy/dx          0.0890254 0.790079 0.1663738
#> HOVAL dy/dx        0.0007506 0.874529 0.0398551
#> fDISCBDm2-m1 dy/dx 0.3088883 0.023322 0.0028303
#> fDISCBDm3-m2 dy/dx 0.3938923 0.990378 0.3349917
#> fDISCBDm4-m3 dy/dx 0.2856400 0.904324 0.6161970
#> fEW1 dy/dx         0.8708760 0.714673 0.4972391
#> 
# \dontrun{
...
#> Coefficients: (asymptotic standard errors) 
#>                   Estimate  Std. Error  z value  Pr(>|z|)
#> (Intercept)     1.89816225  0.24400199   7.7793 7.327e-15
...
#> lag.I(NOX^2)   -0.38640403  0.22253428  -1.7364 0.0824967
#> lag.I(RM^2)    -0.00451252  0.00148919  -3.0302 0.0024440
#> lag.AGE         0.00149678  0.00068470   2.1860 0.0288128
#> lag.log(DIS)   -0.00453785  0.10056961  -0.0451 0.9640104
#> lag.log(RAD)   -0.00940702  0.03127787  -0.3008 0.7636002
...
#> lag.log(LSTAT)  0.09846780  0.03574183   2.7550 0.0058697
#> 
